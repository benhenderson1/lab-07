...
ggplot(data = evals, mapping = aes(x = gender, y = score)) + geom_point()

summarise(score, mean_score = mean(score))

ggplot(data = evals, aes(x = score, y = bty_avg)) + geom_point()

ggplot(data = evals, aes(x = score, y = bty_avg)) + geom_jitter()

```

This data visualisation shows that most students rate their courses quite highly as there is a large count of students who rate their course between score 4 and 5.
From my summary statistic, the mean score is 4.17473 
